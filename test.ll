...
define i32 @Classes.run(i8* %_0) {
    ...
    %_4 = getelementptr [0 x i8*], [0 x i8*]* @.Base_vtable, i32 0 
    store i8** %_4, i8*** %_3 
    ...
    %_9 = getelementptr [0 x i8*], [0 x i8*]* @.Derived_vtable, i32 0 
    store i8** %_9, i8*** %_8 
...
define i32 @Base.set(i8* %_0, i32 %.0) {
    %0 = alloca i32
    store i32 %.0, i32* %0 
    %_1 = load i32, i32* %0 
    %_2 = add i32 0, 8
...
define i32 @Base.get(i8* %_8) {
}
define i32 @Derived.set(i8* %_0, i32 %.0) {
    %0 = alloca i32
    store i32 %.0, i32* %0 
    %_1 = load i32, i32* %0 
    %_2 = add i32 0, 2
