...
define i32 @main() {
    ...
    %_4 = getelementptr [1 x i8*], [1 x i8*]* @.TV_vtable, i32 0, i32 0 
    store i8** %_4, i8*** %_3 
...
define i32 @TV.Start(i8* %_0) {
    ...
    %_38 = load i8*, i8** %_37
    %_39 = bitcast i8* %_38 to i1 (i8*, i32)*
    %_40 = add i32 0, 24
    %_41 = call i1 %_39(i8* %_33, i32 %_40)
    ...
    %_49 = add i32 0, 4
    %_50 = call i1 %_48(i8* %_42, i32 %_49)
    ...
    %_62 = load i8**, i8*** %_61
    %_63 = add i32 0, 12
    %_64 = getelementptr i8*, i8** %_62, i32 %_63 
    %_65 = load i8*, i8** %_64
    %_66 = bitcast i8* %_65 to i1 (i8*, i32)*
    %_67 = add i32 0, 20
    %_68 = call i1 %_66(i8* %_60, i32 %_67)
    ...
    %_71 = load i8**, i8*** %_70
    %_72 = add i32 0, 12
    %_73 = getelementptr i8*, i8** %_71, i32 %_72 
    %_74 = load i8*, i8** %_73
    %_75 = bitcast i8* %_74 to i1 (i8*, i32)*
    %_76 = add i32 0, 28
    %_77 = call i1 %_75(i8* %_69, i32 %_76)
    ...
    %_83 = load i8*, i8** %_82
    %_84 = bitcast i8* %_83 to i1 (i8*, i32)*
    %_85 = add i32 0, 14
    %_86 = call i1 %_84(i8* %_78, i32 %_85)
    ...
    %_89 = load i8**, i8*** %_88
    %_90 = add i32 0, 18
    %_91 = getelementptr i8*, i8** %_89, i32 %_90 
    %_92 = load i8*, i8** %_91
    %_93 = bitcast i8* %_92 to i1 (i8*)*
    %_94 = call i1 %_93(i8* %_87)
    ...
    %_96 = add i32 0, 32
    %_97 = add i32 0, 1
    %_100 = call i8* @calloc(i32 %_97, i32 %_96)
    %_98 = bitcast i8* %_100 to i8***
    %_99 = getelementptr [1 x i8*], [1 x i8*]* @.MyVisitor_vtable, i32 0, i32 0 
    store i8** %_99, i8*** %_98 

    store i8* %_100, i8** %4
    %_101 = add i32 0, 50000000
    call void (i32) @print_int(i32 %_101) 
    %_102 = load i8*, i8** %1 
    %_103 = bitcast i8* %_102 to i8***
    %_104 = load i8**, i8*** %_103
    %_105 = add i32 0, 20
    %_106 = getelementptr i8*, i8** %_104, i32 %_105 
    %_107 = load i8*, i8** %_106
    %_108 = bitcast i8* %_107 to i32 (i8*, i8*)*
    %_109 = load i8*, i8** %4 
    %_110 = call i32 %_108(i8* %_102, i8* %_109)

    store i32 %_110, i32* %3
    %_111 = add i32 0, 100000000
    ...
    %_155 = add i32 0, 12
    %_156 = call i32 %_154(i8* %_148, i32 %_155)
    ...
    %_163 = bitcast i8* %_162 to i1 (i8*, i32)*
    %_164 = add i32 0, 12
    %_165 = call i1 %_163(i8* %_157, i32 %_164)
    ...
    %_169 = add i32 0, 18
    %_170 = getelementptr i8*, i8** %_168, i32 %_169 
    %_171 = load i8*, i8** %_170
    %_172 = bitcast i8* %_171 to i1 (i8*)*
    %_173 = call i1 %_172(i8* %_166)
    ...
    %_177 = add i32 0, 17
    %_178 = getelementptr i8*, i8** %_176, i32 %_177 
    %_179 = load i8*, i8** %_178
    %_180 = bitcast i8* %_179 to i32 (i8*, i32)*
    %_181 = add i32 0, 12
    %_182 = call i32 %_180(i8* %_174, i32 %_181)
...
l41:
    ...
    %_85 = load i8*, i8** %3 
    %_86 = load i8*, i8** %2 
    %_87 = call i1 %_84(i8* %_78, i8* %_85, i8* %_86)
...
l34:
    ...
    %_95 = load i8*, i8** %3 
    %_96 = load i8*, i8** %2 
    %_97 = call i1 %_94(i8* %_88, i8* %_95, i8* %_96)
...
l56:
    ...
    %_32 = call i1 %_23(i8* %_17, i32 %_31)
...
l43:
    ...
    %_16 = load i8*, i8** %1 
    %_17 = load i8*, i8** %2 
    %_18 = call i1 %_15(i8* %_9, i8* %_16, i8* %_17)
...
l46:
    ...
    %_34 = load i8*, i8** %1 
    %_35 = load i8*, i8** %2 
    %_36 = call i1 %_33(i8* %_27, i8* %_34, i8* %_35)
...
l47:
    ...
    %_60 = call i32 %_59(i8* %_53)

    store i32 %_60, i32* %5
    %_61 = bitcast i8* %_0 to i8*
    ...
    %_68 = load i32, i32* %4 
    %_69 = load i32, i32* %5 
    %_70 = call i1 %_67(i8* %_61, i32 %_68, i32 %_69)
...
l50:
    ...
    %_103 = call i1 %_98(i8* %_92, i8* %_102)
    ...
    %_111 = add i1 0, 0 
    %_112 = call i1 %_110(i8* %_104, i1 %_111)
...
define i32 @Tree.accept(i8* %_0, i8* %.1) {
    %1 = alloca i8*
    store i8* %.1, i8** %1 
    %2 = alloca i32
    %_1 = add i32 0, 333
...
l75:
    ...
    %_41 = call i1 %_40(i8* %_34)

    br i1 %_41, label %l76, label %l77
l76:
    %_42 = bitcast i8* %_0 to i8*
    %_43 = bitcast i8* %_42 to i8***
    %_44 = load i8**, i8*** %_43
    %_45 = add i32 0, 19
    %_46 = getelementptr i8*, i8** %_44, i32 %_45 
...
define i32 @Visitor.visit(i8* %_0, i8* %.1) {
    %1 = alloca i8*
    store i8* %.1, i8** %1 
    %2 = alloca i32
    %_1 = load i8*, i8** %1 
...
l79:
    ...
    store i8* %_16, i8** %_19
    %_20 = add i32 0, 16
    %_21 = getelementptr i8, i8* %_0, i32 %_20 
    ...
    %_31 = call i32 %_29(i8* %_23, i8* %_30)
...
l82:
    ...
    store i8* %_48, i8** %_51
    %_52 = add i32 0, 8
    %_53 = getelementptr i8, i8* %_0, i32 %_52 
    %_54 = bitcast i8* %_53 to i8**
    %_55 = load i8*, i8** %_54
    %_56 = bitcast i8* %_55 to i8***
    %_57 = load i8**, i8*** %_56
    ...
    %_63 = call i32 %_61(i8* %_55, i8* %_62)
...
define i32 @MyVisitor.visit(i8* %_0, i8* %.1) {
    %1 = alloca i8*
    store i8* %.1, i8** %1 
    %2 = alloca i32
    %_1 = load i8*, i8** %1 
...
l87:
    ...
    %_48 = call i1 %_47(i8* %_41)

    br i1 %_48, label %l88, label %l89
l88:
    %_49 = load i8*, i8** %1 
    %_50 = bitcast i8* %_49 to i8***
    %_51 = load i8**, i8*** %_50
    ...
    %_57 = add i32 0, 8
    %_58 = getelementptr i8, i8* %_0, i32 %_57 
    %_59 = bitcast i8* %_58 to i8**
    store i8* %_56, i8** %_59
    %_60 = add i32 0, 8
    %_61 = getelementptr i8, i8* %_0, i32 %_60 
    %_62 = bitcast i8* %_61 to i8**
    %_63 = load i8*, i8** %_62
    ...
    %_68 = load i8*, i8** %_67
    %_69 = bitcast i8* %_68 to i32 (i8*, i8*)*
    %_70 = bitcast i8* %_0 to i8*
    %_71 = call i32 %_69(i8* %_63, i8* %_70)
