...
public class IRStatement {
    ...
    public void addLoadPtrAtIndexSym(int arr_ptr_sym, int shifted_by_one_index_reg, int to_reg) {
        String str = String.format("    %%_%d = getelementptr i32, i32* %%%d, i32 %%_%d \n",to_reg, arr_ptr_sym, shifted_by_one_index_reg); 
        stmt_str.append(str);
    }
